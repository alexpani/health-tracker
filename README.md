...
- **Diario** (`/journal`) — lista di tutte le voci di diario in ordine cronologico (mese piu' recente in alto), con casella di ricerca testuale, chip filtro per tag e preset di periodo. Click su una voce porta al `/day/:date` corrispondente, dove la voce si edita.
